...
#pragma warning restore 0649
    public void StartTypingText()
    {
        ...
        dialogueLines.Enqueue("<delay = 0.1>...</delay>");
        dialogueLines.Enqueue("<delay = 0.1>...</delay>");
        dialogueLines.Enqueue("Получен сигнал." +
            "\nПеревод управления корабля искусственному интеллекту......." +
            "\nИнициация протокола последний ковчег......." +
            "\nПроверка систем корабля......." +
            "\nСистемы корабля в удовлетворительном состоянии." +
            "\nПроверка вооружения.......");
        dialogueLines.Enqueue("Лазерный комплекс в норме.\nПулеметный комплекс в норме. \nРельсотрон в норме.");
        dialogueLines.Enqueue("Запуск реактора............." +
            "\nРеактор запущен.\nЗапуск маршевых двигателей. \nЗарядка сверхвсветового двигателя." +
            "\nРасчет маршрута......." +
            "\nКоличество сверхсветовых прыжков: 9");
